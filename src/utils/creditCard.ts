export enum creditCardsName {
  MASTERCARD = 'mastercard',
  DIBBERSCLUB = 'dinnersclub',
  AMERICANEXPRESS = 'americanexpress',
  VISA = 'visa',
  ELO = 'elo',
}

export const creditCardBrandMapper = [
  {
    pattern: /^4[0-9]{6,}$/,
    brand: creditCardsName.VISA,
  },
  {
    pattern:
      /^(5[1-5][0-9]{14}|2(22[1-9][0-9]{12}|2[3-9][0-9]{13}|[3-6][0-9]{14}|7[0-1][0-9]{13}|720[0-9]{12}))$/,
    brand: creditCardsName.MASTERCARD,
  },
  {
    pattern: /^3(?:0[0-5]|[68][0-9])[0-9]{11}$/,
    brand: creditCardsName.DIBBERSCLUB,
  },
  {
    pattern:
    ...
    brand: creditCardsName.ELO,
  },
  {
    pattern: /^3[47]\d{13,14}$/,
    brand: creditCardsName.AMERICANEXPRESS,
  },
  {
